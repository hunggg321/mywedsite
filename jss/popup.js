        ...
        $(document).ready(function() {
            ...
            $('h1').click(function() {
                ...
                $(this).next('#k').slideDown('fast');
					...
					$("#divResult").html("</br><h2>ĐÚNG GÙI NÈ <img src='http://duminhphongadv.com/files/assets/3.png'</img></h2>");
					$("#divResult").fadeIn(2000,function()
							{
							$("#divResult2").fadeOut(0);
							$("#divResult2").html("<p>♥ GIỎI QUÁ! GIỎI QUÁ! .<img src='http://duminhphongadv.com/files/assets/4.png'/></p></br>");
							$("#divResult2").fadeIn(2000,function()
									{
									$("#divResult3").fadeOut(0);
									$("#divResult3").html("<p>YÊU EM NHIỀU ♥.HẾT DỊCH DẪN ANH ĐI ĂN XIÊN NHÍA HIHI^^  <img src='http://duminhphongadv.com/files/assets/5.png'/></p></br>");
